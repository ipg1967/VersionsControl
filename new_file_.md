...
`git remote` - управление удаленным репозиторием

`git pull` - получение данных из удаленного репо и слияние с локальным

`git push` - передача данных из локального в удаленный репо
